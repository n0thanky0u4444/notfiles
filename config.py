...
config.bind('Y', 'open https://www.yewtu.be/feed/subscriptions')
config.bind('C', 'hint links spawn -u untrack-url -O {hint-url}')
...
#searchengines
c.url.searchengines = {
    'DEFAULT':  'https://www.alltheinternet.com/?q={}',
...
fg_default = "#ffffff"
# "#b6bdca"
bg_lightest = "#685e57"         # main shade lightest
fg_error = "#e06c75"            # red
# "#d19a66"                     # orange
bg_hint = "#685e57"             # yellow
fg_matched_text = "#685e57"     # green
bg_passthrough_mode = "#000000" # teal
bg_insert_mode = "#000000"      # blue
...
c.hints.border = f'0px solid'


#fonts
c.fonts.completion.entry = "10pt 'Cozette'"

c.fonts.completion.category = "10pt 'Cozette'"

c.fonts.debug_console =  "10pt 'Cozette'"

c.fonts.downloads =  "10pt 'Cozette'"

c.fonts.hints =  "10pt 'Cozette'"

c.fonts.keyhint =  "10pt 'Cozette'"

c.fonts.messages.error =  "10pt 'Cozette'"

c.fonts.messages.info =  "10pt 'Cozette'"

c.fonts.messages.warning = "10pt 'Cozette'"
...
c.fonts.default_family = ["Inconsolata-dz for Powerline", "Monospace", "DejaVu Sans Mono", "Monaco", "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", "Courier", "Liberation Mono", "monospace", "Fixed", "Consolas", "Terminal"]
